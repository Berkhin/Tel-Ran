...
public class TaxIsrael {
	...
	public static void main(String[] args) {
		double netSalary = netSalary(20000, 5.25);
		System.out.println("Net = " + netSalary);

	}

	public static double netSalary(double salary, double netAllowance) {

		return salary - taxIsrael(salary, netAllowance);
	}

	public static double taxIsrael(double salary, double netAllowance) {
